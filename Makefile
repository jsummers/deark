...
OFILES_MODS:=$(addprefix $(OBJDIR)/modules/,os2bmp.o eps.o bsave.o \
 ...
 epocimage.o psionpic.o psionapp.o exe.o ani.o jpeg2000.o zip.o atari.o \
 fnt.o nokia.o grob.o t64.o cardfile.o tivariable.o basic-c64.o ico.o \
 unsupported.o)
