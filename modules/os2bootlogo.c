...
typedef struct localctx_structOS2BL {
...
static void do_decompress_plane(deark *c, lctx *d, int pn)
{
	...
	struct de_os2exepack2_params eparams;
	...
	de_zeromem(&eparams, sizeof(struct de_os2exepack2_params));
	...
	fmtutil_os2exepack2_codectype1(c, &dcmpri, &dcmpro, &dres, (void*)&eparams);
	d->uses_lzss = eparams.uses_lzss;
