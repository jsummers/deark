...
// codec_private_params = type de_os2exepack2_params, or NULL.
void fmtutil_os2exepack2_codectype1(deark *c,
	struct de_dfilter_in_params *dcmpri, struct de_dfilter_out_params *dcmpro,
	struct de_dfilter_results *dres, void *codec_private_params)
{
	struct exepack2_ctx *ectx = NULL;
	struct de_os2exepack2_params *params = (struct de_os2exepack2_params*)codec_private_params;
