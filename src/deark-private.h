...
void de_bitmap_write_to_file(de_bitmap *img, const char *token, UI createflags);
...
#define DE_CRCOBJ_CRC32_JAMCRC 0x11
#define DE_CRCOBJ_CRC32_PL     0x12
#define DE_CRCOBJ_ADLER32      0x15
